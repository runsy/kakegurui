...
init -1 python hide:
    ...
    config.main_menu_music = "sound/music/Eric Matyas-Analog Nostalgia.ogg"
    ...
    ##   'init'.)
python early:
    config.save_directory = "Pekerrechos-1398547015"
